...
CI = round(read.xlsx("MIP_MA.xlsx", sheet = "CI", colNames = FALSE))

## Demanda Final (DF) - (5.2)

DF = round(read.xlsx("MIP_MA.xlsx", sheet = "DF", colNames = FALSE))

## Valor Bruto da Producao (VBP) - (5.3)

VBP = round(read.xlsx("MIP_MA.xlsx", sheet = "VBP", colNames = FALSE))

## VAlor Adicionado (VA) - (5.4)

VAB = round(read.xlsx("MIP_MA.xlsx", sheet = "VAB", colNames = FALSE))

## Remuneracoes (REM) - (5.5)

REM = round(read.xlsx("MIP_MA.xlsx", sheet = "REM", colNames = FALSE))

## Pessoal Ocupado (PO) - (5.6)

PO = round(read.xlsx("MIP_MA.xlsx", sheet = "PO", colNames = FALSE))

## Consumo das Familias (CF) - (5.7)

CF = round(read.xlsx("MIP_MA.xlsx", sheet = "CF", colNames = FALSE))

## Setor de Pagamentos (SP) - (5.8)

SP = round(read.xlsx("MIP_MA.xlsx", sheet = "SP", colNames = FALSE))

## Setores (SET) - (5.9)

SET = read.xlsx("MIP_MA.xlsx", sheet = "SET", colNames = FALSE)

colnames(SET) = "Setores"

## Impostos (T) - (5.9)

TRIB = round(read.xlsx("MIP_MA.xlsx", sheet = "TRIB", colNames = FALSE))
...
openxlsx::write.xlsx(x = temp,
                     file = "Matriz inversa de Leontief - modelo aberto.xlsx")
